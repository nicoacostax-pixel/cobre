    ...
    <tr><td align="center">
      <table width="540" cellpadding="0" cellspacing="0" style="max-width:540px;width:100%">
        ...
        <tr><td style="background:white;padding:36px 40px">
          <p style="margin:0 0 24px;font-size:15px;color:#444;line-height:1.7">Gracias por unirte. Estos son los pasos para arrancar hoy:</p>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:16px">
            <tr>
              ...
              <td>
                ...
                <p style="margin:0;font-size:13px;color:#777;line-height:1.6">Si no ves más correos nuestros, revisa spam y agréganos como contacto seguro.</p>
              </td>
            </tr>
          </table>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:16px">
            <tr>
              ...
              <td>
                ...
                <a href="https://chat.whatsapp.com/F55Or9hAnPoF2FfjrcYNnE" style="display:inline-block;background:linear-gradient(135deg,#7C5CBF,#574088);color:white;padding:10px 20px;border-radius:10px;font-size:13px;font-weight:700;text-decoration:none">Entrar al grupo</a>
              </td>
            </tr>
          </table>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:32px">
            <tr>
              ...
              <td>
                <p style="margin:0 0 4px;font-size:14px;font-weight:800;color:#1a1a1a">Activa notificaciones en nuestro perfil</p>
                <p style="margin:0;font-size:13px;color:#777;line-height:1.6">Entra a nuestro perfil, dale like a los últimos posts y activa las notificaciones para no perderte nada.</p>
              </td>
            </tr>
          </table>

          <p style="margin:0 0 4px;font-size:14px;color:#555;line-height:1.7">Nos vemos adentro,</p>
          <p style="margin:0;font-size:14px;color:#7C5CBF;font-weight:bold">Nico</p>
        </td></tr>
